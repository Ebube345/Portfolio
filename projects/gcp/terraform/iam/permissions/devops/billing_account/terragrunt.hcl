# 
# permissions that is given to the devops project
# permission to generate service accounts inside the devops project
...
include "devops" {
    path = "${dirname(find_in_parent_folders())}/_env/iam/billing-account.hcl"
}
